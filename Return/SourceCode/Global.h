...
constexpr float		FWND_W			= static_cast<float>( WND_W );	// ウィンドウの幅.
constexpr float		FWND_H			= static_cast<float>( WND_H );	// ウィンドウの高さ.
constexpr float		FFPS			= static_cast<float>( FPS );	// フレームレート.
