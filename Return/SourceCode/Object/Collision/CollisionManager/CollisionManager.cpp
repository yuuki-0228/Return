...
//---------------------------.
bool Coll2D::IsBox2DToPoint2D( CBox2D* pMyBox, const D3DXPOSITION3& pOpPos )
{
	return Coll2D::IsBox2DToPoint2D( pMyBox, { pOpPos.x, pOpPos.y } );
}
...
//---------------------------.
bool Coll2D::IsSphere2DToPoint2D( CSphere2D* pMySphere, const D3DXPOSITION3& pOpPos )
{
	return Coll2D::IsSphere2DToPoint2D( pMySphere, { pOpPos.x, pOpPos.y } );
}
