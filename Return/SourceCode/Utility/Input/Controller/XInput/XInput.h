...
//----------------------------.
template<typename... T>
bool CXInput::IsORPress( WORD Key, T... t )
{
...
//----------------------------.
template<typename... T>
bool CXInput::IsORKeyDown( WORD Key, T... t )
{
	CXInput* pI = GetInstance();
	if ( pI->m_IsNotActiveStop && !CDirectX11::IsWindowActive() ) return false;
...
//----------------------------.
template<typename... T>
bool CXInput::IsORKeyUp( WORD Key, T... t )
{
	CXInput* pI = GetInstance();
	if ( pI->m_IsNotActiveStop && !CDirectX11::IsWindowActive() ) return false;
...
//----------------------------.
template<typename... T>
bool CXInput::IsORKeyRepeat( WORD Key, T... t )
{
	CXInput* pI = GetInstance();
	if ( pI->m_IsNotActiveStop && !CDirectX11::IsWindowActive() ) return false;
...
//----------------------------.
template<typename... T>
bool CXInput::IsANDPress( WORD Key, T... t )
{
	CXInput* pI = GetInstance();
	if ( pI->m_IsNotActiveStop && !CDirectX11::IsWindowActive() ) return false;
...
//----------------------------.
template<typename... T>
bool CXInput::IsANDKeyDown( WORD Key, T... t )
{
	CXInput* pI = GetInstance();
	if ( pI->m_IsNotActiveStop && !CDirectX11::IsWindowActive() ) return false;
...
//----------------------------.
template<typename... T>
bool CXInput::IsANDKeyUp( WORD Key, T... t )
{
	CXInput* pI = GetInstance();
	if ( pI->m_IsNotActiveStop && !CDirectX11::IsWindowActive() ) return false;
...
//----------------------------.
template<typename... T>
bool CXInput::IsANDKeyRepeat( WORD Key, T... t )
{
	CXInput* pI = GetInstance();
	if ( pI->m_IsNotActiveStop && !CDirectX11::IsWindowActive() ) return false;
