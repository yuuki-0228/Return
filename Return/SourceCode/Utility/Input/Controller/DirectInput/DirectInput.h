...
//----------------------------.
template<typename... T>
bool CDirectInput::IsORPress( DIRECT_INPUT_KEY Key, T... t )
{
...
//----------------------------.
template<typename... T>
bool CDirectInput::IsORKeyDown( DIRECT_INPUT_KEY Key, T... t )
{
	std::vector<WORD> KeyList = { Key, t... };
	for ( auto& k : KeyList ) {
...
//----------------------------.
template<typename... T>
bool CDirectInput::IsORKeyUp( DIRECT_INPUT_KEY Key, T... t )
{
	std::vector<WORD> KeyList = { Key, t... };
	for ( auto& k : KeyList ) {
...
//----------------------------.
template<typename... T>
bool CDirectInput::IsORKeyRepeat( DIRECT_INPUT_KEY Key, T... t )
{
	std::vector<WORD> KeyList = { Key, t... };
	for ( auto& k : KeyList ) {
...
//----------------------------.
template<typename... T>
bool CDirectInput::IsANDPress( DIRECT_INPUT_KEY Key, T... t )
{
	std::vector<WORD> KeyList = { Key, t... };
	for ( auto& k : KeyList ) {
...
//----------------------------.
template<typename... T>
bool CDirectInput::IsANDKeyDown( DIRECT_INPUT_KEY Key, T... t )
{
	std::vector<WORD> KeyList = { Key, t... };
...
//----------------------------.
template<typename... T>
bool CDirectInput::IsANDKeyUp( DIRECT_INPUT_KEY Key, T... t )
{
	std::vector<WORD> KeyList = { Key, t... };
...
//----------------------------.
template<typename... T>
bool CDirectInput::IsANDKeyRepeat( DIRECT_INPUT_KEY Key, T... t )
{
	std::vector<WORD> KeyList = { Key, t... };
	for ( auto& k : KeyList ) {
