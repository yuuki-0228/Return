...
private:
	...
	CFlagManager( const CFlagManager & )				= delete;
	CFlagManager& operator = ( const CFlagManager & )	= delete;
	CFlagManager( CFlagManager && )						= delete;
	CFlagManager& operator = ( CFlagManager && )		= delete;
};
