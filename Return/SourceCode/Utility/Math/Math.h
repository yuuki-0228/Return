...
namespace Math {
	...
	constexpr float RADIAN_MAX	= 360.0f * ( PI / 180.0f );	// ラジアンの最大値.
	constexpr float RADIAN_MID	= 180.0f * ( PI / 180.0f );	// ラジアンの中間値.
	constexpr float RADIAN_MIN	= 0.0f;						// ラジアンの最小値.
	constexpr float DEGREE_MAX	= 360.0f;					// デグリーの最大値.
	constexpr float DEGREE_MID	= 180.0f;					// デグリーの中間値.
	constexpr float DEGREE_MIN	= 0.0f;						// デグリーの最小値.
