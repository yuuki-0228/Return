...
public:
	...
	// インスタンスの取得.
	static CWindowText* GetInstance();
...
private:
	...
	CWindowText( const CWindowText & )				= delete;
	CWindowText& operator = ( const CWindowText & ) = delete;
	CWindowText( CWindowText && )					= delete;
	CWindowText& operator = ( CWindowText && )		= delete;
};